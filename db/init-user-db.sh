...
psql -v ON_ERROR_STOP=1 --username "$POSTGRES_USER" <<-EOSQL
    ...
    ALTER USER "shared_db" CREATEDB;
    CREATE DATABASE "shared_db";
    ALTER DATABASE "shared_db" OWNER to "shared_db";
    ...
    GRANT ALL ON ALL TABLES IN SCHEMA public TO shared_db;
    GRANT ALL ON ALL SEQUENCES IN SCHEMA public TO shared_db;
EOSQL

psql -v ON_ERROR_STOP=1 --username "$POSTGRES_USER" <<-EOSQL
    CREATE USER "apim_db";
    ALTER USER "apim_db" CREATEDB;
    CREATE DATABASE "apim_db";
    ALTER DATABASE "apim_db" OWNER to "apim_db";
    ...
    GRANT ALL ON ALL TABLES IN SCHEMA public TO apim_db;
    GRANT ALL ON ALL SEQUENCES IN SCHEMA public TO apim_db;
